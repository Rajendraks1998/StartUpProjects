...
public class ProductController {
    ...
    public ResponseEntity<List<ProductDto>> getProductByUserId(@PathVariable("userId") Long userId){
        List<ProductDto> productDto = productService.getProductsByUserId(userId);
        return new ResponseEntity<>(productDto, HttpStatus.OK);
    }

    @GetMapping("/search")
    public ResponseEntity<List<ProductDto>> getProductsByUsername(@RequestParam String username) {
        List<ProductDto> products = productService.getProductsByUsername(username);
